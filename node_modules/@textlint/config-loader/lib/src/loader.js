...
exports.loadPreset = exports.loadRules = exports.loadFilterRules = exports.loadPlugins = void 0;
    ...
    await Promise.all(Object.entries(rulesObject).map(async ([ruleId, ruleOptions]) => {
        try {
            ...
            if (replacedDefinition) {
                ...
                if (!(0, is_1.isTextlintFilterRuleReporter)(ruleModule)) {
    ...
    await Promise.all(Object.entries(rulesObject).map(async ([ruleId, ruleOptions]) => {
        try {
            ...
            if (replacedDefinition) {
                ...
                if ((0, config_util_1.isPresetRuleKey)(ruleId)) {
                    // load preset
                    ...
                    const mod = await (0, import_1.dynamicImport)(resolvePackage.filePath);
                    const ruleModule = (0, module_interop_1.moduleInterop)(mod.default);
                    if (!(0, is_1.isTextlintRuleModule)(ruleModule)) {
